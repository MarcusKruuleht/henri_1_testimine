...
type PalgakalkulaatorServiceData = {
    calculate: (gross: number) => number | undefined;
};

export const PalgakalkulaatorService = (): PalgakalkulaatorServiceData => {
...
export const usePalgakalkulaatorService = injectableHook(PalgakalkulaatorService);